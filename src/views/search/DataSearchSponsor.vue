  ...
  <div class="content" v-show="!dialogFormVisible">
        ...
        <el-row>
          ...
          <el-col>
            <el-form-item label="违约原因：">
              <el-checkbox v-model="form.defaultNotch">6个月内，交易对手技术性或资金等原因，给当天结算带来头寸缺口2次以上</el-checkbox>
            </el-form-item>
          </el-col>
          <el-col>
          ...
          <el-col>
            <el-form-item style="margin-left: 80px;">
              <el-checkbox v-model="form.defaultExternal">在其他金融机构违约（包括不限于：人行征信记录中显示贷款分类状态不良类情况， 逾期超过 90 天等），或外部评级显示为违约级别</el-checkbox>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <div class="table_zone">
      ...
      >
        ...
        <el-table-column prop="clientName" label="客户姓名" :show-overflow-tooltip="true"/>
        <el-table-column prop="defaultState" label="审核状态" width="100" />
        <el-table-column prop="defaultSeverity" label="严重程度" width="100" :show-overflow-tooltip="true" />
        <el-table-column prop="sponsorId" label="认定人id" width="140" v-if="false" />
        <el-table-column prop="sponsorName" label="认定人" width="140" :show-overflow-tooltip="true" />
        <el-table-column prop="defaultRete" label="最新外部等级" width="100" :show-overflow-tooltip="true" v-if="false"/>
        ...
        <el-table-column prop="defaultNotch" label="缺口" width="140" show-overflow-tooltip v-if="false"/>
        <el-table-column prop="defaultCancel" label="撤单" width="140" show-overflow-tooltip v-if="false"/>
        <el-table-column prop="defaultDelay" label="延期" width="140" show-overflow-tooltip v-if="false"/>
        <el-table-column prop="defaultRelate" label="关联" width="140" show-overflow-tooltip v-if="false"/>
        <el-table-column prop="defaultSubstitute" label="消极置换" width="140" show-overflow-tooltip v-if="false"/>
        <el-table-column prop="defaultBankrupt" label="破产保护" width="140" show-overflow-tooltip v-if="false"/>
        <el-table-column prop="defaultExternal" label="违约" width="140" show-overflow-tooltip v-if="false"/>
        <el-table-column prop="defaultRemark" label="备注" width="140" show-overflow-tooltip v-if="false" />
